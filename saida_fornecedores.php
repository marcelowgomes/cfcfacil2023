...
<?php /// ALUNOS
$sql = "SELECT * FROM fornecedores WHERE fornecedor_cfc = '$user[user_empresa]' and fornecedor_status = '1' and fornecedor_lixeira = 1 order by fornecedor_nome";
$exe = mysqli_query($conn, $sql);
?>



<div class="container"><h4>Fluxo de Caixa > Fornecedores > Saídas</h4>
...
<a href="nova_saida_fornecedor/<?php echo $user['fornecedor_id'] ?>" class="text-dark fw-500">
<h6><?php echo $user['fornecedor_nome'] ?> </h6>
</a>
</div> </td>
		<td><div class="userDatatable-inline-title">
<a href="nova_saida_fornecedor/<?php echo $user['fornecedor_id'] ?>" class="text-dark fw-500">
<h6><?php echo $user['fornecedor_cpf'] ?> </h6>
</a>
</div></td>
		<td><div class="userDatatable-inline-title">
<a href="nova_saida_fornecedor/<?php echo $user['fornecedor_id'] ?>" class="text-dark fw-500">
<h6><?php echo $user['fornecedor_telefone'] ?> </h6>
</a>
</div></td>
		<td>  <a href="nova_saida_fornecedor/<?php echo $user['fornecedor_id'] ?>" class="view">
