                ...
                if (in_array(date('H:i', $horario_inicio), $tempo_inicio_intervalo_descanso) && in_array(date('H:i', $horario_fim), $tempo_final_intervalo_descanso)) {
                    ...
                    if($aluno_disponivel == ''){
                        ...
                        <input type="hidden" name="horario_inicio" value="' . date('H:i', $horario_inicio) . '">
                            ...
                            <i class="fas fa-info-circle" data-bs-toggle="modal" data-bs-target="#modal-info-delete'.$horario_inicio.$horario_fim.$semana.$j.'"></i>
...
<OPTION VALUE='' SELECTED> Informe o aluno ";
// Selecionando os dados da tabela em ordem decrescente
$sql = "SELECT * FROM alunos where aluno_cfc = '$user[user_empresa]' order by aluno_nome ";
// Executando $sql e verificando se tudo ocorreu certo.
$resultado = mysqli_query($conn, $sql);
//Realizando um loop para exibi&ccedil;&atilde;o de todos os dados 
while ($linha=mysqli_fetch_array($resultado)) {
echo "<OPTION VALUE='".$linha['aluno_id']."' ";
echo ">".$linha['aluno_nome'];
}
echo "</SELECT>";
?>

<label>Informe o instrutor</label>
...
<input type="hidden" name="horario_inicio" value="' . date('H:i', $horario_inicio) . '">
   ...
   ' ?>
         <button type="submit" class="btn btn-success btn-outlined btn-sm" data-bs-dismiss="modal">Agendar</button>
...
<?php
                       ...
                       . '<div id="aberto'. $horario_inicio.$horario_fim.$semana.$j.'" style="display:block">'
                        ...
                        . $primeiroNome .  ' '. $ultimoNome . ' <br>'. $ultimoNome . '
