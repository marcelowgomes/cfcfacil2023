...
$conn->query("update carrinho set carrinho_status = 2 , carrinho_pedido = $id_venda  where carrinho_aluno = $_POST[aluno] and carrinho_status='1' and carrinho_cfc = $user[user_empresa] and carrinho_tipo = 'avulso'  and carrinho_ocorrencia = 'Saida'");
...
@$conn->query($insert = "INSERT INTO contas_apagar (apagar_vencimento,apagar_valor,apagar_venda, apagar_cliente,  
apagar_cfc, apagar_usuario, apagar_parcela, apagar_parcelas) VALUES ('$vencimento[$i]', '$valor[$i]', '$id_venda','$_POST[aluno]','$user[user_empresa]','$user[user_empresa]','$parcela[$i]','$_POST[parcelas]')");
  }
