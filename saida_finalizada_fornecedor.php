...
<div>
                 ...
                 <div>
<h4>Saída registrada -   <?php echo ($dados['fornecedor_nome']) ?> </h4>
<div class='mt-2 d-flex'>
<p><strong>CPF/CNPJ: </strong><?php echo ($dados['fornecedor_cpf']) ?></p>&nbsp; 
</div>
</div>  </div></div></div>
...
<div class="card border-0 px-25"><br>
 ...
 Tudo ok saida registrada com sucesso.
   ...
   <br>
  <div> <a href="saida_fornecedores"> <button class="btn btn-info"> Nova Saída Fornecedores </button></a></div> 
<br><br>
               </div>
            </div>
         </div>
