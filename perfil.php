                     ...
                     <div class="account-profile">
                        ...
                        <div class="ap-nameAddress pb-3 pt-1">
                           ...
                           <p class="ap-nameAddress__subTitle fs-14 m-0">
                              <img src="img/svg/map-pin.svg" alt="map-pin" class="svg">London, England
                           </p>
                        </div>
                        <div class="ap-button button-group d-flex justify-content-center flex-wrap">
                           <button type="button" class="border text-capitalize px-25 color-gray transparent radius-md">
                              <img class="svg" src="img/svg/mail.svg" alt="mail">message</button>


                           <button class="btn btn-primary btn-default btn-squared text-capitalize  px-25"><img src="img/svg/user-plus.svg" alt="user-plus" class="svg">
                              follow
                           </button>
                     ...
                     <div class="card-body pt-md-1 pt-0">
                        <div class="user-content-info">
                           <p class="user-content-info__item">
                              <img class="svg" src="img/svg/mail.svg" alt="mail">Clayton@example.com
                           </p>
                           <p class="user-content-info__item">
                              <img src="img/svg/phone.svg" alt="phone" class="svg">+44 (0161) 347
                              8854
                           </p>
                                 ...
                                 <div class="card-body border-top border-bottom py-0 ap-main-post__reaction">
                                    <div class="d-flex align-items-center demo-h-spacing ap-post-content__feedback">
                                       <a href="#" class="d-inline-flex align-items-center">
                                          <img class="svg" src="img/svg/thumbs-up.svg" alt="thumbs-up">274
                                       </a>
                                       <a href="#" class="d-inline-flex align-items-center">
                                          <img class="svg" src="img/svg/message-square.svg" alt="message-square">56</a>
                                       <a href="#" class="d-inline-flex align-items-center">
                                          <img class="svg" src="img/svg/share-2.svg" alt="share-2"> share
                                       </a>
                                    </div>
                                 </div>
                                 <!-- Blog Style End -->
                                          ...
                                          <div class="d-flex justify-content-between align-items-center w-100">
                                             <div class=" flex-1 d-flex align-items-center me-10 ap-post-content-comment__write">
                                                ...
                                                <div class="d-flex">
                                                   ...
                                                   <a href="#">
                                                      <img class="svg" src="img/svg/image.svg" alt="image"></a>
                                                   <a href="#">
                                                      <img class="svg" src="img/svg/paperclip.svg" alt="paperclip"></a>
                                                </div>
                                             </div>
                                                      ...
                                                      <div class="pt-0 outline-0 pb-0 pe-0 ps-0 rounded-0 position-relative d-flex align-items-center" tabindex="-1">
                                                         <div class="d-flex justify-content-between align-items-center w-100">
                                                            <div class=" flex-1 d-flex align-items-center me-10 ap-post-content-comment__write ms-0">
                                                               ...
                                                               <div class="d-flex">
                                                                  <a href="#">
                                                                     <img src="img/svg/smile.svg" alt="smile" class="svg"></a>
                                                                  <a href="#">
                                                                     <img src="img/svg/image.svg" alt="image" class="svg"></a>
                                                                  <a href="#">
                                                                     <img src="img/svg/paperclip.svg" alt="paperclip" class="svg">
                                                                  </a>
                                                               </div>
                                                            </div>
                                                            <button type="button" class="border-0 btn-primary wh-50 p-10 rounded-circle">
                                                               <img src="img/svg/send.svg" alt="send" class="svg"></button>
                                                         </div>
                                                      </div>
                                                   </div>
                                                </div>
