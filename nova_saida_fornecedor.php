...
$sql = "SELECT * from fornecedores WHERE fornecedor_id = '$id' and fornecedor_cfc = $user[user_empresa] ";
$sql2 = "SELECT * from receitas_despesas where receita_cfc = $user[user_empresa] and receita_ocorrencia = 'Saida' and receita_incidencia = 'Fornecedor' ";
...
<div>
                 ...
                 <div>
                    <h4>Nova Saída > Fornecedores >  <?php echo ($dados['fornecedor_nome']) ?> </h4>
                    <div class='mt-2 d-flex'>
        <p><strong>CNPJ/CPF: </strong><?php echo ($dados['fornecedor_cpf']) ?></p>&nbsp; -
        <p class='mx-2'><strong>Telefone: </strong><?php echo ($dados['fornecedor_telefone']) ?></p>
      </div>
                 </div>  </div></div></div>
...
<div class="card border-0 px-25">
  ...
  $sql2a = "SELECT * from carrinho  where carrinho_fornecedor = $id and carrinho_status='1' and carrinho_cfc = $user[user_empresa] and carrinho_item = $produto[receita_id]  ";
...
<input type="hidden" name="fornecedor"  value="<?php echo $id ?>"> 
...
var formData = new FormData(this);
  $.ajax({
    url: 'caixa_saida_fornecedor.php',
    cache: false,
    data: formData,
    type: "POST",  
