...
$sql = "SELECT * from colaboradores WHERE colaborador_id = '$id' and colaborador_cfc = $user[user_empresa] ";
$sql2 = "SELECT * from receitas_despesas where receita_cfc = $user[user_empresa] and receita_ocorrencia = 'Saida' and receita_incidencia = 'Colaborador' ";
...
<div>
                 ...
                 <div>
                    <h4>Nova Saída > Colaboradores >  <?php echo ($dados['colaborador_nome']) ?> </h4>
                    <div class='mt-2 d-flex'>
        <p><strong>CNPJ/CPF: </strong><?php echo ($dados['colaborador_cpf']) ?></p>&nbsp; 
      </div>
                 </div>  </div></div></div>
...
<div class="card border-0 px-25">
  ...
  $sql2a = "SELECT * from carrinho  where carrinho_colaborador = $id and carrinho_status='1' and carrinho_cfc = $user[user_empresa] and carrinho_item = $produto[receita_id]  ";
...
<input type="hidden" name="colaborador"  value="<?php echo $id ?>"> 
...
var formData = new FormData(this);
  $.ajax({
    url: 'caixa_saida_colaborador.php',
    cache: false,
    data: formData,
    type: "POST",  
