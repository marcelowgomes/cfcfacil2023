...
<iframe src="agenda_geral_veiculos.php?id=<?php echo $id ?>&id2=<?php echo $id2?>&veiculo=<?php echo $_POST[veiculo] ?>&instrutor=<?php echo $_POST[instrutor] ?>&cat=<?php echo $_POST[cat] ?>" width="100%" height="1000px">
</iframe>
