...
$sql = "SELECT * from colaboradores WHERE colaborador_id = '$caixa[caixa_colaborador]' and colaborador_cfc = $user[user_empresa] ";
...
<div>
                 ...
                 <div>
<h4>Saída registrada -   <?php echo ($dados['colaborador_nome']) ?> </h4>
<div class='mt-2 d-flex'>
<p><strong>CPF: </strong><?php echo ($dados['colaborador_cpf']) ?></p>&nbsp; 
</div>
</div>  </div></div></div>
...
<div class="card border-0 px-25"><br>
 ...
 Tudo ok saida registrada com sucesso.
   ...
   <br>
  <div> <a href="saida_colaboradores"> <button class="btn btn-info"> Nova Saída Colaboradores </button></a></div> 
<br><br>
               </div>
            </div>
         </div>
