...
$sql = "SELECT * from veiculos WHERE id_veiculo = '$id' and veiculo_cfc = $user[user_empresa] ";
$sql2 = "SELECT * from receitas_despesas where receita_cfc = $user[user_empresa] and receita_ocorrencia = 'Saida' and receita_incidencia = 'Veiculo' ";
...
<div>
                 ...
                 <div>
                    <h4>Nova Saída > Veículos >  <?php echo $dados['marca_veiculo'] ?> <?php echo $dados['modelo_veiculo'] ?> <?php echo $dados['cor_veiculo'] ?> </h4>
                    <div class='mt-2 d-flex'>
        <p><strong>Placa: </strong><?php echo ($dados['placa_veiculo']) ?></p>&nbsp; 
      </div>
                 </div>  </div></div></div>
...
<div class="card border-0 px-25">
  ...
  $sql2a = "SELECT * from carrinho  where carrinho_veiculo = $id and carrinho_status='1' and carrinho_cfc = $user[user_empresa] and carrinho_item = $produto[receita_id]  ";
...
<input type="hidden" name="veiculo"  value="<?php echo $id ?>"> 
