...
<?php /// ALUNOS
$sql = "SELECT * FROM veiculos WHERE veiculo_cfc = '$user[user_empresa]' and veiculo_status = '1' and veiculo_lixeira = 1 ";
$exe = mysqli_query($conn, $sql);
?>


<div class="container"><h4>Fluxo de Caixa > Veículos > Saídas</h4>
...
<th>
<span  class="userDatatable-title">Veiculo</span>
</th>
<th>
...
<a href="nova_saida_veiculo/<?php echo $user['id_veiculo'] ?>" class="text-dark fw-500">
<h6><?php echo $user['marca_veiculo'] ?> <?php echo $user['modelo_veiculo'] ?> <?php echo $user['cor_veiculo'] ?> </h6>
</a>
</div> </td>
		<td><div class="userDatatable-inline-title">
<a href="nova_saida_veiculo/<?php echo $user['id_veiculo'] ?>" class="text-dark fw-500">
<h6><?php echo $user['placa_veiculo'] ?> </h6>
</a>
</div></td>
		
		<td>  <a href="nova_saida_veiculo/<?php echo $user['id_veiculo'] ?>" class="view">
