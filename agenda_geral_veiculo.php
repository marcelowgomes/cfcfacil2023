...
/// VEICULOS
$sqla = "SELECT * FROM veiculos WHERE veiculo_cfc = '$user[user_empresa]' and id_veiculo = '$_POST[veiculo]'";
$exea = mysqli_query($conn, $sqla);
$veiculo = mysqli_fetch_array($exea);
               ...
               <div class="row">
                  <div class="col-lg-12">
                     ...
                     <div class="breadcrumb-main">
                        <h4 class="text-capitalize breadcrumb-title"><i class="fas fa-calendar-alt"></i> Agenda > Veículo > <?php echo $veiculo[modelo_veiculo] ?> - <?php echo $veiculo[placa_veiculo] ?>  </h4>
...
<iframe src="agenda_veiculos.php?id=<?php echo $id ?>&id2=<?php echo $id2?>&veiculo=<?php echo $_POST[veiculo] ?>&instrutor=<?php echo $_POST[instrutor] ?>&cat=<?php echo $_POST[cat] ?>" width="100%" height="1000px">
</iframe>
