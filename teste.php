...
$sql2 = "SELECT * from carrinho  where carrinho_aluno = $aluno and carrinho_status='1' and carrinho_cfc = $user[user_empresa] and carrinho_item = $item and carrinho_ocorrencia = '$oco' ";
...
$sql = "SELECT * from carrinho c inner join receitas_despesas rd ON c.carrinho_item = rd.receita_id where c.carrinho_aluno = $aluno and c.carrinho_status='1' and c.carrinho_cfc = $user[user_empresa] and carrinho_ocorrencia = '$oco'  order by c.carrinho_id desc " ;
...
<script>
   ...
   $('#departamento').on('change', function() {
     ...
     $.ajax({
        url: 'parcelas_crediario.php?id='+id,
        cache: false,
        data: dados,
        type: "POST",  
